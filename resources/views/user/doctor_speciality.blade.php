...
<body>
  ...
  <header>
    ...
    <div class="container">
        ...
        <div style="width:70%;float:left;margin:15px 0;padding:10px 15px;text-align:center;" >

              @foreach($info as $doctor)
                <a href="{{route('doctor_details', $doctor->id)}}">
                  <div style="float:left;margin:10px 15px;" id="details">
                      <h3>{{$doctor->name}}</h3>
                      <img src="{{ asset('doctorimages/'.$doctor->image) }}" alt="not found"> <!-- if image not previewing-->
