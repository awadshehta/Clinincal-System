...
<body>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
              <a href="#"><span class="mai-call text-primary"></span> +2 01000000000</a>
      ...
      <div class="container">
        ...
        <div class="navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{url('find_doctor')}}">Find A Doctor</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#appointment">Make Appointment</a>
            </li>
  ...
  <footer class="page-footer">
    <div class="container">
      <div class="row px-md-3" id="about">
